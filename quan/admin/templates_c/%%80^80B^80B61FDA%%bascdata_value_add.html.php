<?php /* Smarty version 2.6.20, created on 2016-01-04 19:35:13
         compiled from bascdata_value_add.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'show_datalist_type_name', 'bascdata_value_add.html', 16, false),)), $this); ?>
...
<table width="99%"  border="0" cellpadding="3" cellspacing="1" class="p_table_order">
  <tr bgcolor="#F7F7F7">
  	<td colspan="13">
    	<div align="left"><strong >添加值</strong>＝》添加<strong style="color:#FF0000"><?php echo ((is_array($_tmp=$this->_tpl_vars['bd_id'])) ? $this->_run_mod_handler('show_datalist_type_name', true, $_tmp) : show_datalist_type_name($_tmp)); ?>
</strong>列表值</div></td>
  </tr>

  <tr bgcolor="#FFFFFF">
    <td><div align="right">显示名称：</div></td>
    <td><input name="tname" type="text" id="tname" size="30"/></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    ...
    <td><label>
      <input name="tvalue" type="text" id="tvalue"  value="" size="30"/>
    </label>     </td>
    </tr>
  <tr bgcolor="#FFFFFF">
    ...
    <td><?php echo $this->_tpl_vars['key']; ?>
      ...
      <label>
      <input name="orderby" type="text" id="orderby"  value="0" size="30"/>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><label>
      <input name="tvalue2" type="text" id="tvalue2"  value="" size="30"/>
      </label>
    </td>
    </tr>
  <tr bgcolor="#FFFFFF">
