...
$barcode_class_path = dirname(__FILE__) . DIRECTORY_SEPARATOR . 'Barcode2';

require_once $barcode_class_path . '/Writer.php';
require_once $barcode_class_path .  '/Driver.php';
require_once $barcode_class_path .  '/Exception.php';
...
class ImageBarcode2
{
    ...
    public static function draw($text,
        ...
        if (!include_once $barcode_class_path . '/' . $type . '.php') {
