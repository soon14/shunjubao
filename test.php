...
amount： <input type="txt" name="amount" value="200.00"><br />
 ...
 returnCode： <input type="txt" name="returnCode" value="0"><br />
...
outChannelNo：  <input type="txt" name="outChannelNo" value=""> <br />
 ...
 payChannelType：  <input type="txt" name="payChannelType" value="rongbao"> <br />

  outTradeNo： <input type="txt" name="outTradeNo" value="wy170511802048">  <br />
