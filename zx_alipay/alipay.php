...
<div id="pay_platform" style="display:none">
    ...
    <div class="ico_title">智赢支付宝支付</div>
    <div class="form_wrap account">
        ...
        <div class="form_list">
            ...
            <span class="list_val">
                <input name="body" value="智赢支付宝支付" maxlength="64" size="32" placeholder="长度127">
            </span>
            <i>*</i><em>长度64</em>
        </div>
        <div class="form_list">
            ...
            <span class="list_val">
                <input name="attach" value="智赢支付宝支付" maxlength="128" size="32" placeholder="长度128">
            </span>
            <em>长度128</em>
        </div>
        <div class="form_list">
