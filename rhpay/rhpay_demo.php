...
switch (get_param('action')){
	 ...
	 case 'product_open'://开通产品
	 
		$serverUrl ="http://portal.ronghuijinfubj.com/middlepayportal/merchant/openProduct";		 
		$post_param["productType"]= get_param('productType');//产品类型
		$post_param["merchantNo"] = get_param('merchantNo');//商户编号
		$post_param["t0Fee"]= get_param('t0Fee');//
		$post_param["t1Fee"]= get_param('t1Fee');//
		 ...
		 $result = http_post_data($serverUrl,$jsonStr); 
	  ...
	  case 'order_add'://下单
		...
		if(empty($orderNum)){
		 ...
		 if(get_param('trxType')=="Alipay_SCANCODE"){//支付宝扫码
			 ...
			 $serverPayUrl ="http://trx.ronghuijinfubj.com/middlepaytrx/alipay/scanCommonCode";
		 }elseif(get_param('trxType')=="WX_SCANCODE"){
			 $SignKey = "YZMiyZu5YC0zRtK6Noa2Ierr0oGMpx3j";
			 $desKey = "Ypw9frAYk8kyQDQUnyy9MhgK";
			 	$matrixPointSize = 7;//生成图片大小
			 $serverPayUrl ="http://trx.ronghuijinfubj.com/middlepaytrx/wx/scanCode";
		 }elseif(get_param('trxType')=="WX_SCANCODE_JSAPI"){
			 $SignKey = "YZMiyZu5YC0zRtK6Noa2Ierr0oGMpx3j";
			 $desKey = "Ypw9frAYk8kyQDQUnyy9MhgK";
