<?php /* Smarty version 2.6.17, created on 2018-05-23 16:14:25
        ...
        <dl>
          ...
          <dd>
            <ul>
              ...
              <li><span style="margin-left: 10px;color: red;">其他金额单笔不超过3000元</span></li>
            </ul>
          </dd>
        </dl>
        <dl>
          ...
          <dd>
            <ol>
              <!--派洛-->
              <!--<li class="weixin"><a href="" class="pay_bank" pay_bank="perWeixin">微信</a></li>-->
              <li class="weixin" style=""><a href="" class="pay_bank" pay_bank="kjmWX" >微信充值</a></li>
              <li class="paypal"><a href="" class="pay_bank" pay_bank="kjmALIPAY">支付宝</a></li>
              <!-- <li class="tenpay" style="display:none"><a href="" class="pay_bank" pay_bank="pertenpay">财付通</a></li>-->
              <!-- <li class="weixin" style="display:none;"><a href="" class="pay_bank" pay_bank="wx">微信充值</a></li>-->
              <!--<li class="jingdong"><a href="" class="pay_bank" pay_bank="jdPayDebitCredit_wap">jd支付</a></li> -->
              ...
              <li class="ningbo" style="display:none;"><a href="" class="pay_bank" pay_bank="NBBANK">宁波银行</a></li>-->
            </ol>
          </dd>
        </dl>
      </div>
...
<div style="display:;">
  <div id="light1" class="white_content">
    <div class="openwindowscenter" style="height:250px;width:320px;">
      <div>
