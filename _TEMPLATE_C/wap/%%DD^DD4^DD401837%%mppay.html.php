<?php /* Smarty version 2.6.17, created on 2017-12-26 10:18:57
         compiled from mppay.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getStaticsUrl', 'mppay.html', 2, false),)), $this); ?>
...
元</p>
        ...
        <dd style=" position:relative;left:-80px;">
          <iframe  style="border:0;padding:0; height:300px; margin:0;" scrolling="no" src="<?php echo @ROOT_DOMAIN; ?>
/wx/native/dynamic_qrcode.php?total_fee=<?php echo $this->_tpl_vars['total_fee']; ?>
...
"></iframe>
	...
	<div style="width:300px; margin:0 auto; text-align:left; line-height:24px;color:#888;">如不能自动识别二维码，请存储支付二维码图像或截图保存，在打微信-扫码-相册选取截图-扫码-确认支付即可。</div>
  </div>
</div>
<script>
