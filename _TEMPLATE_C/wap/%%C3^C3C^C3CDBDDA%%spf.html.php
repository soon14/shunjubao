<?php /* Smarty version 2.6.17, created on 2017-10-18 16:21:03
            ...
            for (var key in listObj) {
                ...
                htmStr += "<tr l='" + goalLine + "' m='" + matchObj.num + "' id='" + key + "'" + ((count % 2 == 0) ? " class='alt'" : "") + ">" +
						  ...
						  "<dt>" +
						   ...
						   "<p style='width:22px;height:42px;line-height:42px;'><span style='color:"+goalline_color+";border:1px solid "+goalline_color+";'>" + matchObj.goalline + "</span></p>" +
