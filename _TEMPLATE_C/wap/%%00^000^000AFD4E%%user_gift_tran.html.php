<?php /* Smarty version 2.6.17, created on 2018-03-06 22:23:45
...
<div class="Jifenes"> <?php if (! $this->_tpl_vars['userVirtualTicketInfo']): ?>
  ...
  <form action="" method="post" id="submit">
    <dl>
      <dt>当前彩金</dt>
      <dd><?php echo $this->_tpl_vars['userAccountInfo']['gift']; ?>
元</dd>
    </dl>
    <dl>
      <dt>可兑换积分</dt>
      <dd><?php echo $this->_tpl_vars['score']; ?>
</dd>
    </dl>
    <dl>
      <dt>输入要兑换积分额度，1彩金等于10积分！</dt>
    </dl>
    <dl class="active">
      <dt style="width:69%;border:1px solid #ddd;">
        <input type="text" name="gift" value="<?php echo $this->_tpl_vars['userAccountInfo']['gift']; ?>
" class="jftext" id="gift"/>
