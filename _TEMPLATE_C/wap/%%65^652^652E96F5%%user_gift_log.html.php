<?php /* Smarty version 2.6.17, created on 2017-11-06 09:28:41
...
/account/user_gift_log.php">彩金明细</a></dt>
  </dl>
</div>
<form method="post">
...
?>
          ...
          <?php endif; ?>
          <tr>
            <td><p style="width:59px; height:30px; line-height:30px; overflow:hidden;"><?php echo $this->_tpl_vars['bankrollChangeType'][$this->_tpl_vars['userGiftLogInfo']['log_type']]['desc']; ?>
</p></td>
            <td><p style="width:65px; height:30px; line-height:30px; overflow:hidden;color:#999;"><?php echo $this->_tpl_vars['userGiftLogInfo']['create_time']; ?>
</p></td>
...
<?php endif; ?></td>
          ...
          <tr>
            <td colspan="5" class="show" style="border-bottom:none; background:#FFFF99;">暂时没有数据!</td>
          </tr>
          <?php endif; ?>
        </table>
      </div>
