<?php /* Smarty version 2.6.17, created on 2017-10-21 15:17:27
         compiled from confirm/hdc_list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getStaticsUrl', 'confirm/hdc_list.html', 195, false),)), $this); ?>
    ...
    function getDataBack(data) {
        ...
        for (var i = 0; i < tmpAry.length; i++) {
            ...
            for (var key in listObj) {
				...
				"<p  class='Rangfen' pool='hdc'>" + matchObj.hdc.goalline + "</p>" +
...
/basketball/hdc_list.php" class="active">让分胜负</a></td>
      <td><a href="<?php echo @ROOT_DOMAIN; ?>
/basketball/bk_crosspool.php">混合过关</a></td>
      <td><a href="<?php echo @ROOT_DOMAIN; ?>
/basketball/wnm_list.php">胜分差</a></td>
      <td><a href="<?php echo @ROOT_DOMAIN; ?>
/basketball/hilo_list.php">大小分</a></td>
    </tr>
  </table>
</div>
<!--center start-->
