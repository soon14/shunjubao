...
.newpartner dl dt.alipay{ width:32px; height:32px; background:url(http://www.zhiying365365.com/www/statics/i/alipaywapicon.png) no-repeat;}
.newpartner dl dt.qq{width:32px; height:32px; background:url(http://www.zhiying365365.com/www/statics/i/qqwapicon.png) no-repeat;}
.newpartner dl dt.weibo{width:32px; height:32px; background:url(http://www.zhiying365365.com/www/statics/i/weibowapicon.png) no-repeat;}
.newpartner dl dt.weixin{width:32px; height:32px; background:url(http://www.zhiying365365.com/www/statics/i/weixinwapicon.png) no-repeat;}
</style>
</head><body>
<div class="top">
...
/passport/forgot.php" style="font-size:14px;color:#999;">忘记密码？</a><a href="http://m.zhiying365365.com/passport/reg.php" style="font-size:14px;color:#999; float:right; position:relative;right:0;">我要注册</a></div>
      <div class="tijiao">
...
" />
    ...
    <div class="newpartner">
      <h1><b>使用合作网站登录</b></h1>
      <dl>
        <dt class="alipay"><a href="https://mapi.alipay.com/gateway.do?_input_charset=utf-8&partner=2088311949386932&return_url=http://m.zhiying365365.com/connect/alipay_connect.php&service=alipay.auth.authorize&target_service=user.auth.quick.login&sign=79baf752edb6ac32cc9ebdfa8ba9ea39&sign_type=MD5">支付宝登录</a></dt>
        <dt class="qq"><a href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=101179991&redirect_uri=http%3A%2F%2Fm.zhiying365365.com%2Fconnect%2Fqq_connect.php&state=acadb2d2318870b40a1b6e48dcb960cd&scope=get_user_info,add_share,add_weibo">QQ登录</a></dt>
        <dt class="weixin"><a href="https://open.weixin.qq.com/connect/qrconnect?appid=wxc1b1ad8efd2af8eb&redirect_uri=http%3A%2F%2Fwww.zhiying365365.com%2Fconnect%2Fweixin_connect.php&response_type=code&scope=snsapi_login&state=79ec3e6d6a0a3b4168f79dc88ce57525#wechat_redirect">微信登录</a></dt>
        <dt class="weibo"><a href="https://api.weibo.com/oauth2/authorize?client_id=3430318831&redirect_uri=http%3A%2F%2Fm.zhiying365365.com%2Fconnect%2Fweibo_connect.php&response_type=code&display=default">新浪微博登录</a></dt>
      </dl>
    </div>
  </div>
</div>
