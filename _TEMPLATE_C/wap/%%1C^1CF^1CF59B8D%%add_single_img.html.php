<?php /* Smarty version 2.6.17, created on 2017-10-21 05:36:05
         compiled from ../default/add_single_img.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getStaticsUrl', '../default/add_single_img.html', 11, false),)), $this); ?>
<style type="text/css">
<!--
.ke-icon-addSingleImg {
      background-image: url("<?php echo @STATICS_BASE_URL; ?>
/j/skins/default/default.gif");
...
<script type="text/javascript" src="<?php echo ((is_array($_tmp='kindeditor.js')) ? $this->_run_mod_handler('getStaticsUrl', true, $_tmp) : getStaticsUrl($_tmp)); ?>
"></script>
