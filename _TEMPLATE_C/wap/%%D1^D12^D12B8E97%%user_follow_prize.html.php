<?php /* Smarty version 2.6.17, created on 2017-11-06 09:32:17
...
/account/user_follow_prize.php">提成明细</a></dt>
      <dd>总额:<?php if ($this->_tpl_vars['dingzhi_total_f_prize']): ?><?php echo $this->_tpl_vars['dingzhi_total_f_prize']; ?>
<?php else: ?>0<?php endif; ?>元</dd>
    </dl>
  </div>
  <form method="post">
  ...
  <div class="shaidantable">
    <div>
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="stripese">
        <tr>
          <th align="left">&nbsp;定制用户</th>
          <th align="center">中奖额度</th>
...
?>
        <tr>
          ...
          <td align="center" style="color:#dc0000;"><?php echo $this->_tpl_vars['item']['prize']; ?>
</td>
          <td align="center" style="color:#999;"><?php echo $this->_tpl_vars['item']['pay_rate']; ?>
</td>
          <td align="center"><?php echo $this->_tpl_vars['item']['f_prize']; ?>
</td>
          <td align="right"><?php echo $this->_tpl_vars['item']['f_status_show']; ?>
&nbsp;</td>
        </tr>
        ...
        <tr>
          <td colspan="9" class="show" style="border-bottom:none; background:#FFFF99;">暂时没有分成的信息!</td>
        </tr>
        <?php endif; ?>
        <tr>
          <td colspan="9" class="show" style="border-bottom:none; background:#fff; text-align:left;">小计：<?php echo $this->_tpl_vars['total_f_prize']; ?>
</td>
        </tr>
      </table>
    </div>
