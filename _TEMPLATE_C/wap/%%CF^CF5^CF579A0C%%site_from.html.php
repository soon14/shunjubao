...
table tr{}
table tr th{border:1px solid #e9e9e9;height:36px;line-height:36px;background:#f9f9f9 url(http://www.shunjubao.xyz/www/statics/i/thBj.jpg) repeat-x left center;font-weight:300;}
...
<div class="mylink">
  <div class="tipss">
    ...
    <br/>
    <br/>
    <p>1) 还在等什么？让您的账号更具价值-聚宝推广中心期待您的加入;</p>
    <p>2）复制下边的链接可进行推广，让您在聚宝的帐号更具价值！</p>
    <br/>
    <br/>
    <br/>
    <p>我的推广链接地址：</p>
...
<div class="tipss">
  ...
  <br/>
  <br/>
  <p>简单的说就是聚宝用户生成一个推广链接地址，之后拿生成出来的链接去推广（QQ群、微信、图片、文字等等资源），通过此链接进来注册的用户，并产生投注行为，就可以拿到1%的返点啦~~~返点于每星期一早上9：00发放至账户余额里边，返点可以用于投注或直接申请提现。</p>
</div>
