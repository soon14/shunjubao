...
/admin/business/manul_ticket_show.php" target="rightFrame">人工出票</a></li>
    ...
    <li> <a class="head">专家管理</a>
      <ul>
        <li><a href="<?php echo @ROOT_DOMAIN; ?>
/admin/zhuanjia/zhuanjia.php" target="rightFrame">专家申请</a></li>
        <li><a href="<?php echo @ROOT_DOMAIN; ?>
/admin/zhuanjia/zhuanjia_dinyue.php" target="rightFrame">专家订阅</a></li>
        <li><a href="<?php echo @ROOT_DOMAIN; ?>
/admin/zhuanjia/zhuanjia_recommend.php" target="rightFrame">专家推荐</a></li>
      </ul>
    </li>
