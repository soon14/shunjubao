<?php /* Smarty version 2.6.17, created on 2017-10-26 13:54:31
         compiled from beidan/sf.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getStaticsUrl', 'beidan/sf.html', 185, false),)), $this); ?>
            ...
            for (var key in listObj) {
                ...
                htmStr += "<tr l='" + goalLine + "' m='" + matchObj.num + "' id='" + key + "'" + ((count % 2 == 0) ? " class='alt'" : "") + ">" +
						  ...
						  "<dt>" +
						   ...
						   "<p style='width:40px;'><span style='color:"+goalline_color+";border:1px solid "+goalline_color+";''>" +  matchObj.goalline + "</span></p>" +
...
/beidan/sf.php" class="active">胜负<span></span></a><a href="<?php echo @ROOT_DOMAIN; ?>
