<?php /* Smarty version 2.6.17, created on 2017-10-17 18:25:18
...
iframe{background:none; width:300px; height:350px;border:none;border-bottom:1px solid #ccc; padding:30px 0 0 0; margin:0;}
iframe img{ width:300px; height:350px;}
</style>
<div class="cnetr">
  <div class="payname">
    <ul>
...
元</p>
      <iframe scrolling="no" src="http://www.zhiying365.com/other_payapi/pearlpay/index.php?subject=<?php echo $this->_tpl_vars['subject']; ?>
&payAmount=<?php echo $this->_tpl_vars['total_fee']; ?>
&payType=11&out_trade_no=<?php echo $this->_tpl_vars['out_trade_no']; ?>
&u_id=<?php echo $this->_tpl_vars['userRealInfo']['u_id']; ?>
"></iframe>
      <p> 手机一扫，支付宝轻松支付！</p>
