<?php /* Smarty version 2.6.17, created on 2018-03-05 05:29:15
         compiled from user_dingzhi.html */ ?>
<!DOCTYPE html><head>
<title>我的定制-定制管理-用户中心-聚宝网</title>
<meta name="keywords" content="聚宝竞彩,聚宝网,聚宝跟单定制管理" />
<meta name="description" content="我的定制，定制管理，聚宝定制跟单不错失任何一红单。" />
...
<div>
  <div class="rightcenetr">
    <h1><span>▌</span>定制管理-我的定制</h1>
  </div>
  <div class="msg" style="text-align:left;">
    <div class="tabuser">
      <ul>
        <li><a href="<?php echo @ROOT_DOMAIN; ?>
/account/user_dingzhi.php" class="active">我的定制</a></li>
        <li><a href="<?php echo @ROOT_DOMAIN; ?>
/account/user_dingzhied.php">定制我的</a></li>
      </ul>
    </div>
...
?>
        <tr>
          ...
          <td align="center"><div class="caozuo"> <a href="user_ticket.php?dingzhi_order=1&follow_id=<?php echo $this->_tpl_vars['item']['follow_id']; ?>
">查看订单</a> <?php if ($this->_tpl_vars['item']['enable'] == 1): ?>
              <?php if ($this->_tpl_vars['item']['status'] == 1): ?> <a href="?id=<?php echo $this->_tpl_vars['item']['id']; ?>
&status=2" > 退订 </a> <?php else: ?> <a href="?id=<?php echo $this->_tpl_vars['item']['id']; ?>
&status=1" > 续订 </a> <?php endif; ?>
              <?php endif; ?> </div></td>
        </tr>
        ...
        <tr>
          <td colspan="8" class="show" style="border-bottom:none; background:#FFFFCC;">暂时没有定制的信息!</td>
        </tr>
        <?php endif; ?>
      </table>
    </div>
