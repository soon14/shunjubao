<?php /* Smarty version 2.6.17, created on 2017-10-15 18:34:44
         compiled from user_gift_log.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getStaticsUrl', 'user_gift_log.html', 2, false),)), $this); ?>
...
/account/user_account_log.php">账户明细</a></li>
        <li><a href="<?php echo @ROOT_DOMAIN; ?>
/account/user_gift_log.php" class="active">彩金明细</a></li>
        <li><a href="<?php echo @ROOT_DOMAIN; ?>
...
?>
        <tr>
          ...
          <td align="center"  style="color:#999;"><?php echo $this->_tpl_vars['userGiftLogInfo']['create_time']; ?>
</td>
          <td align="center"><?php if ($this->_tpl_vars['bankrollChangeType'][$this->_tpl_vars['userGiftLogInfo']['log_type']]['direction'] == 1): ?><?php echo $this->_tpl_vars['userGiftLogInfo']['gift']; ?>
元<?php endif; ?></td>
          <td align="center"><?php if ($this->_tpl_vars['bankrollChangeType'][$this->_tpl_vars['userGiftLogInfo']['log_type']]['direction'] == 2): ?><?php echo $this->_tpl_vars['userGiftLogInfo']['gift']; ?>
元<?php endif; ?></td>
          ...
          <?php endif; ?>
          <td align="right"><?php echo $this->_tpl_vars['userGiftLogInfo']['old_gift']; ?>
元 </td>
        </tr>
        <?php endforeach; endif; unset($_from); ?>
        
        <?php if (! $this->_tpl_vars['userGiftLogInfos']): ?>
        <tr>
