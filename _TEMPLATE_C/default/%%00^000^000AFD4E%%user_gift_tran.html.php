<?php /* Smarty version 2.6.17, created on 2018-03-09 06:35:42
         compiled from user_gift_tran.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getStaticsUrl', 'user_gift_tran.html', 1, false),)), $this); ?>
...
<div class="rightcenetr">
  <h1><span>▌</span>彩金换积分</h1>
  <div class="tabuser">
    <ul>
      <li><a href="http://www.shunjubao.xyz/account/user_gift_tran.php" class="active">彩金兑换积分</a></li>
  ...
  <div> <?php if (! $this->_tpl_vars['userVirtualTicketInfo']): ?>
    ...
    <?php else: ?>
    <h2 style="font-size:14px;">您的总彩金：<span><?php echo $this->_tpl_vars['userAccountInfo']['gift']; ?>
</span>&nbsp;&nbsp;可兑换积分：<span><?php echo $this->_tpl_vars['score']; ?>
</span></h2>
      ...
      <form action="" method="post" id="submit">
        <dl>
          ...
          <dd style="position:relative;left:-50px;">
            <input type="text" name="gift" value="<?php echo $this->_tpl_vars['userAccountInfo']['gift']; ?>
" id="gift"/>
    ...
    <div  style=" font-size:12px;color:#777; line-height:24px;">
      <p>各位会员，积分是聚宝网回馈用户的一种方式，积分可用于积分投注，积分可以兑换成彩金，彩金可以购买国彩。为使每个用户都能获取到聚宝赠送的积分，现对原有积分规则中，月投注额区间段未有赠送积分的部分进行调整，调整的积分新规则于2017年4月1号00：00：00执行，请须知。</p>
      <p><b>积分获取规则</b></p>
      ...
      <p><b>积分返还及兑换日期</b></p>
      <p>账户原有积分可任何时间段兑换彩金。当月投注总额所得积分，聚宝将按照“积分获取规则”于每月月初第一天早上9点前，派送上月（月末最后一天23：59：59前的投注总额）。</p>
