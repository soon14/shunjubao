<?php /* Smarty version 2.6.17, created on 2018-03-04 23:33:16
         compiled from dingzhi.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'string_format', 'dingzhi.html', 130, false),)), $this); ?>
<!DOCTYPE html>
...
<link href="http://www.zhiying365365.com/www/statics/c/dingzhi.css" type="text/css" rel="stylesheet" />
<link href="http://www.zhiying365365.com/www/statics/c/footer.css" type="text/css" rel="stylesheet" />
<script type="text/javascript" src="http://www.zhiying365365.com/www/statics/j/navigator.js"></script>
...
<script type="text/javascript" src="http://www.zhiying365365.com/www/statics/j/float.js"></script>
<script type="text/javascript" src="http://www.zhiying365365.com/www/statics/j/winmac.js"></script>
...
unset($_smarty_tpl_vars);
 ?>
<div class="tipsters" style="height:118px;">
  <div class="sdanTop">
    <div class="sdannav">
      <h1 style="font-family:'微软雅黑'; font-weight:300;">跟单定制<span style=" font-style:normal;">,</span>不错失任何一红单...<br/><br/>
        专家和明星会员推荐<span  style=" font-style:normal;">,</span>打造竞彩中奖的福地！</h1>
    </div>
  </div>
</div>
<div class="shaiTag" style="position:relative; top:-14px;">
  <ul style="position:relative;left:-10px;">
    <li><a href="<?php echo @ROOT_DOMAIN; ?>
/ticket/dingzhi.php" class='active'>跟单定制</a></li>
    <li class="gs"></li>
  </ul>
  <div class="clear"></div>
</div>
<div style="text-align:left; width:1000px; margin:0 auto; line-height:26px;">
  <p style="color:#dc0000; padding:15px 0 0 0; font-weight:900;">特别说明：</p>
...
function turnoff(obj){document.getElementById(obj).style.display="none";}
  ...
  <div id="light2" class="white_content" >
    <div class="MSCenter" style="height:200px;">
      ...
      <div id="showtips" style="text-align:center; line-height:30px; font-size:20px;"></div>
    </div>
  </div>
    ...
    <form   method="post" >
      <div class="MSCenter">
        ...
        <div class="sdanopenwindows">
          ...
          <dl class="tips">
            <dd><span>*</span><strong>温馨提示：</strong>一旦定制，晒单人晒单后，您将自动进行跟单，并扣除账户余额。如需退订，请到“用户中心”-“我的定制”进行操作！</dd>
          </dl>
          <dl>
            <dd class="sub">
        ...
        <h2>跟单定制，不错失任何一红单，专家和明星会员推荐，打造竞彩中奖的福地！</h2>
      </div>
    </form>
  </div>
  <!--弹出定制 end-->
  <div class="gendanCenter">
    <div class="shaidantable"><br/>
      <table width="970" border="0" cellspacing="0" cellpadding="0" id="list">
        <tr>
          <th align="left"><span>用户名</span></th>
          <th>注册时间</th>
          <th>战绩</th>
          <th>胜率(周)</th>
...
?>
        <tr>
          <td class="first"><b><img src="<?php if ($this->_tpl_vars['item']['u_img']): ?><?php echo $this->_tpl_vars['item']['u_img']; ?>
<?php else: ?><?php echo @STATICS_BASE_URL; ?>
/i/touxiang.jpg<?php endif; ?>"><span><?php echo $this->_tpl_vars['item']['u_name']; ?>
</span></b><?php if ($this->_tpl_vars['item']['s_recomond'] == 2): ?><em>推荐</em><?php endif; ?></td>
          <td><u><?php echo $this->_tpl_vars['item']['u_jointime']; ?>
</u></td>
...
if(u_id==""){
	...
	success: function(data) {
		if(data.status == "success"){
			...
			$("#showtips").html('恭喜您已成功定制，查看<a href="http://www.zhiying365365.com/account/user_center.php?p=dingzhi" >我的定制</a');
			document.getElementById('light1').style.display='none';
			document.getElementById('light2').style.display='block';
			document.getElementById ('fade').style.display='block';	
