...
/account/user_site_from.php" class="active">我的推广</a></li>
    ...
    <h2 style="font-size:14px; line-height:24px;">简单的说就是聚宝用户生成一个推广链接地址，之后拿生成出来的链接去推广（QQ群、微信、图片、文字等等资源），通过此链接进来注册的用户，并产生投注行为，就可以拿到1%的返点啦~~~返点于每星期一早上9：00发放至账户余额里边，返点可以用于投注或直接申请提现。</h2>
    <br/>
    <br/>
    <br/>
    <p>还在等什么？让您的账号更具价值-聚宝推广中心期待您的加入!</p>
    <br/>
    <br/>
  </div>
