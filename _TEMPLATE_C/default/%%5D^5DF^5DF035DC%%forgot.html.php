...
<?php endif; ?></span> </dd>
      ...
      <input type="hidden" name="from" value="http://www.zhiying365365.com/ticket/show.php" />
    </form>
    <div class="lianhelogin">
      <h2>使用合作网站登录</h2>
      <ul>
        <li><a href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=101179991&redirect_uri=http%3A%2F%2Fwww.zhiying365365.com%2Fconnect%2Fqq_connect.php&state=519325605e4f681a2c0589ca19d741ed&scope=get_user_info,add_share,add_weibo"><img src="<?php echo @STATICS_BASE_URL; ?>
/i/QQlogin.gif">QQ登录</a></li>
        <li><a href="https://mapi.alipay.com/gateway.do?_input_charset=utf-8&partner=2088311949386932&return_url=http://www.zhiying365365.com/connect/alipay_connect.php&service=alipay.auth.authorize&target_service=user.auth.quick.login&sign=eec67941b9a9e81899e345ed53b2873b&sign_type=MD5"><img src="<?php echo @STATICS_BASE_URL; ?>
/i/alipaylogin.gif">支付宝登录</a></li>
        <li><a href="https://open.weixin.qq.com/connect/qrconnect?appid=wxc1b1ad8efd2af8eb&redirect_uri=http%3A%2F%2Fwww.zhiying365365.com%2Fconnect%2Fweixin_connect.php&response_type=code&scope=snsapi_login&state=782141d36830c698e07e22dfd9bfa129#wechat_redirect"><img src="<?php echo @STATICS_BASE_URL; ?>
/i/weixin2.gif">微信登录</a></li>
        <li><a href="https://api.weibo.com/oauth2/authorize?client_id=3430318831&redirect_uri=http%3A%2F%2Fwww.zhiying365365.com%2Fconnect%2Fweibo_connect.php&response_type=code&display=default"><img src="<?php echo @STATICS_BASE_URL; ?>
