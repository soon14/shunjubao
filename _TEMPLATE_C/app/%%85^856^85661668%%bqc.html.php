<?php /* Smarty version 2.6.17, created on 2016-04-15 21:16:48
         compiled from beidan/bqc.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getStaticsUrl', 'beidan/bqc.html', 269, false),)), $this); ?>
        ...
        for (var i = 0; i < tmpAry.length; i++) {
            ...
            for (var key in listObj) {
                ...
                "<td style='width:65px;'>" +
						  ...
						  "<p><a class='o' href='javascript:void(0);'><strong>主-主</strong><labe class='oddsItem'l>" + matchObj.BQC.hh + "</label></a></p>" +
						   
						  "<p><a class='o' href='javascript:void(0);'><strong>主-平</strong><labe class='oddsItem'l>" + matchObj.BQC.hd + "</label></a></p>" +
						  
						  "<p><a class='o' href='javascript:void(0);'><strong>主-客</strong><label class='oddsItem'>" + matchObj.BQC.ha + "</label></a></p>" +
						  
						  "<p><a class='o' href='javascript:void(0);'><strong>平-主</strong><label class='oddsItem'>" + matchObj.BQC.dh + "</label></a></p>" +
						  
						  "<p><a class='o' href='javascript:void(0);'><strong>平-平</strong><label class='oddsItem'>" + matchObj.BQC.dd + "</label></a></p>" +
						  
						  "<p><a class='o' href='javascript:void(0);'><strong>平-客</strong><label class='oddsItem'>" + matchObj.BQC.da + "</label></a></p>" +
						  
						  "<p><a class='o' href='javascript:void(0);'><strong>客-主</strong><label class='oddsItem'>" + matchObj.BQC.ah + "</label></a></p>" +
						  
						  "<p><a class='o' href='javascript:void(0);'><strong>客-平</strong><label class='oddsItem'>" + matchObj.BQC.ad + "</label></a></p>" +
						  
						  "<p><a class='o' href='javascript:void(0);'><strong>客-客</strong><label class='oddsItem'>" + matchObj.BQC.aa + "</label></a></p>" +
