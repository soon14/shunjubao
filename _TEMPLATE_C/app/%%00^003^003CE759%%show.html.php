...
<div class="tipsters">
  <div class="NewsNav">
    <h1><em>智赢网智赢晒单、跟单中心！停止盲目投注...<br/>
      <span>跟随智赢高手，让您的利润蒸蒸日上 ! </span></em></h1>
  </div>
</div>
<div class="gendanCenter">
  <style>
.hfsad{background:url(http://www.zhiying365365.com/www/statics/i/hfsad1.jpg) no-repeat right center; height:80px; position:relative;}
