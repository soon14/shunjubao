<?php /* Smarty version 2.6.17, created on 2016-06-15 16:48:39
...
<div class="wapxtags">
  <ul>
    <li><a href="http://app.zhiying365.com/account/user_score_tran.php">&nbsp;&nbsp;&nbsp;积分换彩金&nbsp;&nbsp;&nbsp;</a></li>
    <li class="active"><a href="http://app.zhiying365.com/account/user_gift_tran.php">&nbsp;&nbsp;&nbsp;彩金换积分&nbsp;&nbsp;&nbsp;</a> </li>
  </ul>
  <div class="clear"></div>
</div>
<div class="jieshao"> <?php if (! $this->_tpl_vars['userVirtualTicketInfo']): ?>
  ...
  <form action="" method="post" id="submit">
    <p>兑换积分：
      <input type="text" name="gift" style=" padding:6px; width:120px;" value="<?php echo $this->_tpl_vars['userAccountInfo']['gift']; ?>
" id="gift"/>
  ...
  <?php endif; ?>
  <p><b>温馨提示：</b></p>
  <p>各位会员，积分是智赢网回馈用户的一种方式，一年来，每天只要您正常登录，系统都会自动赠送一个积分，但是鉴于恶意注册者越来越多， 智赢网特决定——于2016年4月1日0点起实行积分赠送新规则。在此之前系统每天免费自动赠送的积分正常保留，并可正常兑换彩金；恶意注册用户及通过智赢圈子同人多号互赏行为者，积分直接清零并做永久封号处理。为保障正常会员的利益，现对积分获取规则进行更改。</p>
  <p><b>积分获取规则</b></p>
