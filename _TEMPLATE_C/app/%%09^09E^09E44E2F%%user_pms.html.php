<?php /* Smarty version 2.6.17, created on 2016-02-22 15:28:01
...
<div class="center">
  <div class="Paymingxi">
    <div class="wapxtags">
      <ul>
        <li class="active"><a href="<?php echo @ROOT_DOMAIN; ?>
/account/user_pms.php?status=1" <?php if ($this->_tpl_vars['status'] == 1): ?> class="active" <?php endif; ?>>&nbsp;&nbsp;未读消息<b>(<?php echo $this->_tpl_vars['unRecieviSum']; ?>
)</b>&nbsp;&nbsp;</a>
        </li>
        <li><a href="<?php echo @ROOT_DOMAIN; ?>
/account/user_pms.php?status=2" <?php if ($this->_tpl_vars['status'] == 2): ?> class="active" <?php endif; ?>>&nbsp;&nbsp;已读消息&nbsp;&nbsp;</a>
        </li>
      </ul>
      <div class="clear"></div>
    </div>
