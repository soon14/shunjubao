<?php /* Smarty version 2.6.17, created on 2016-02-18 19:49:24
    ...
    function getDataBack(data) {
        ...
        for (var i = 0; i < tmpAry.length; i++) {
            ...
            for (var key in listObj) {
				...
				"<li class='wf' style='display:none;'>让球玩法</li>" +
				
				"</ul>" +
				
				"<dl>" +
				
				"<dt class='"+ ((matchObj.danguan_mnl == 1)? "bdgsaishi":"")+"'>" +
				...
				"<dt class='"+ ((matchObj.danguan_hdc == 1)? "bdgsaishi":"")+"'>" +
				
				"<p><a class='o' href='javascript:void(0);'><span>客胜</span><strong class='line' pool='hdc'>" + matchObj.hdc.goalline + "</strong><b><label class='oddsItem'>" + ((matchObj.hdc == undefined) ? "" : matchObj.hdc.a) + "</label></b></a></p>" +
				
				"<p><a class='o' href='javascript:void(0);'><span>主胜</span><strong class='line' pool='hdc'>" + matchObj.hdc.goalline + "</strong><b><label class='oddsItem'>" + ((matchObj.hdc == undefined) ? "" : matchObj.hdc.h) + "</label></b></a></p>" +
