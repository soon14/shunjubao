<?php /* Smarty version 2.6.17, created on 2016-04-13 05:18:39
    ...
    function getDataBack(data) {
        ...
        for (var i = 0; i < tmpAry.length; i++) {
            ...
            for (var key in listObj) {
				...
				"<p class='Rangfen'><label class='line' pool='hilo'>" + ((matchObj.hilo == undefined) ? "" : matchObj.hilo.goalline) + "</label></p>" 
