<?php /* Smarty version 2.6.17, created on 2016-04-23 18:01:43
...
.Tips{text-align:center;border-top:1px dashed #fff;height:24px;line-height:18px;color:#000;font-size:12px; background:url(http://www.zhiying365.com/www/statics/i/wbg.gif) repeat-x;}
...
.systemtips p span{background:url(http://www.zhiying365.com/www/statics/i/raster.jpg) no-repeat 0 -96px;width:50px;display:inline-table;display:inline-block;zoom:1;*display:inline;}
.systemtips p em{background:url(http://www.zhiying365.com/www/statics/i/raster.jpg) no-repeat 61% 90%;width:50px;display:inline-table;display:inline-block;zoom:1;*display:inline;font-style:normal;}
.ohter{height:100px;}
.ohter p{height:30px;line-height:30px;padding:28px 0 0 10px;}
.ohter p span{background:url(http://www.zhiying365.com/www/statics/i/showRight.png) no-repeat left bottom;width:16px;height:14px;display:inline-table;display:inline-block;zoom:1;*display:inline;}
...
">继续投注</a><span></span><a href="http://ios.zhiying365.com/account/user_center.php">用户中心</a><span></span><a href="http://ios.zhiying365.com/">返回首页</a></p>
    </div>
  </div>
  <!--投注成功 end-->
...
/football/hdc_list.html">投注竞彩篮球</a><span></span><a href="http://ios.zhiying365.com/">返回首页</a></p>
    </div>
  </div>
  <!--比赛已开赛 end-->
...
">去登录</a><span></span><a href="http://ios.zhiying365.com/">返回首页</a></p>
    </div>
  </div>
  <!--比赛已截止 end-->
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
    ...
    <div class="ohter">
      <p><span></span><a href="http://ios.zhiying365.com/account/user_center.php?p=realinfo">去认证</a></p>
    </div>
  </div>
  <?php endif; ?> </div>
<!--center end-->
