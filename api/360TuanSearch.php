...
$sign = $params['sign'];
$cp_key = Qihoo360Connect::TUAN_CP_KEY;
...
//$params = array(
//	'start_time'	=> '2012-10-07 15:00:00',
//	'end_time'	=> '2012-11-12 23:00:00',
//	'last_order_id' => '1211121087553',
//	'order_ids'	=> ',1211121087553,1211081020908,1211071412963,',
//	'order_ids'	=> '1211071412963',
//);
$ids = $objUserOrderForStatisFront->tuan360Search($params);
...
foreach ($userOrders as $userOrder) {
	...
	$cps_info = $userOrder['360_tuan_cps'];
	if (!trim($cps_info)) {
		continue;
	} else {
	...
	foreach ($orderIds as $orderId) {
			...
			foreach ($orderAttr as $tmpOrderAttr) {
				...
				$divide = ConvertData::toMoney($price * $amount * Qihoo360Connect::TUAN_ATIOR , false); # 分成
				$total_comm += $divide;
				
				$atior = (Qihoo360Connect::TUAN_ATIOR * 100).'%'; #分成比例
	...
	$total_comm = ConvertData::toMoney($total_comm - $coupon * Qihoo360Connect::TUAN_ATIOR, false);
	$commission = $commission.ConvertData::toMoney($coupon * Qihoo360Connect::TUAN_ATIOR, false);
