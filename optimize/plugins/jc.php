...
$money    = isset($_REQUEST['TotalMoney']) ? intval($_REQUEST['TotalMoney']) : '';//投注钱数
$multiple = isset($_REQUEST['multiple']) ? trim($_REQUEST['multiple']) : 1;//投注倍数
$childtype           = isset($_REQUEST['childtype'])?trim($_REQUEST['childtype']):'';//过关方式
$lotterycode    = isset($_REQUEST['lotterycode']) ? trim($_REQUEST['lotterycode']):'';//投注信息yuhua_lotterymode
$sport = isset($_REQUEST['sport']) ? trim($_REQUEST['sport']):'fb';//投注信息yuhua_lotterymode
