...
$out_trade_no = "cib".date('YmdHis',time()). $rands;//订单号
$u_id = $userInfo['u_id'];
...
$get_ali_url = "http://www.zhiying365365.com/other_payapi/cib/request_wap.php?method=submitOrderInfo&body=$body&attach=$attach&total_fee=$total_fee&mch_create_ip=$mch_create_ip&out_trade_no=$out_trade_no";
