...
$to_ali_url = "/other_payapi/cib2alipayjsh5/do.php?body=$body&total_fee=$total_fee&out_trade_no=$out_trade_no";
//$to_ali_url = file_get_contents($get_ali_url);
//header("Location: ".$get_ali_url); 
//exit();
...
$YOKA ['output'] = $tpl->r ( 'cib2_h5alipay' );
