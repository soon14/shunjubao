...
$ordetTicketInfo = json_encode($ordetTicketInfo);
temp_errorLog($ordetTicketInfo,"../templog/ordetTicketInfo.txt");

function temp_errorLog($log,$filename='error.txt'){
	//$filename = 'error.txt';
