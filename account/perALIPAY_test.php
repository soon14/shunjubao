...
$get_ali_url = "http://news.shunjubao.com/other_payapi/pearlpay/index_test.php?subject=$subject&payAmount=$total_fee&payType=".$payType."&out_trade_no=$out_trade_no&u_id=$u_id";
