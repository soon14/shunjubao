...
$default_bank = trim($_GET["default_bank"]);
...
<form action="../action/ClientOrder_jdPayDebitCredit.php" method="post" >
  <div class="content">
    <div class="content_0">
      <label>交易类型-tradeType:</label>
      <input type="txt" name="tradeType" value="cs.pay.submit">
      <br/>
        u_id:   <input type="txt" name="userId" id="userId" value="<?=$u_id?>">
          accessType:   <input type="txt" name="accessType" id="accessType" value="<?=$accessType?>">
        <br/>
      <br/>
      ...
      <select id="channel" onchange="changeChannel(this)" name="channel">
        ...
        <option value="jdPayDebitCredit" selected>京东支付（借贷）</option>
      </select>
      <br/>
