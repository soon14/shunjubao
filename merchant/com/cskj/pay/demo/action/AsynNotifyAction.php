...
if($resultCode=="0"){//支付成功
	...
	$turl='http://www.shunjubao.xyz/services/wypay_return.php?out_trade_no='.$outTradeNo.'&total_fee='.$amount.'&trade_status='.$trade_status.'&dtime='.$dtime.'&sign='.$sign.'&mchId='.$outChannelNo;
